...
<body>
    <div class="sidebar-shell">
        <aside class="sidebar">
            ...
            <a href="${pageContext.request.contextPath}/admin-dashboard" class="active"><i class="bi bi-people"></i> Người dùng</a>
            <a href="${pageContext.request.contextPath}/manage-buses"><i class="bi bi-truck"></i> Xe bus</a>
            <a href="${pageContext.request.contextPath}/manage-routes"><i class="bi bi-map"></i> Tuyến xe</a>
            <a href="${pageContext.request.contextPath}/manage-stations"><i class="bi bi-geo-alt"></i> Điểm dừng</a>
            <a href="${pageContext.request.contextPath}/manage-schedules"><i class="bi bi-calendar-event"></i> Lịch trình</a>
